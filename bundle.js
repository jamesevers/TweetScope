...
var Maps = {
  initialState: function initialState() {
    ...
    d3.json("https://d3js.org/us-10m.v1.json", function (error, us) {
      ...
      statesGroup.selectAll("path").attr("class", "states").data(topojson.feature(us, us.objects.states).features).enter().append("path").attr("d", path).attr("fill", "#1D2951").attr("opacity", .8);
  ...
  drawMap: function drawMap() {
    ...
    d3.json("https://d3js.org/us-10m.v1.json", function (error, us) {
      ...
      svg.append("g").attr("class", "states").selectAll("path").data(topojson.feature(us, us.objects.states).features).enter().append("path").attr("d", path).attr("fill", "#1D2951").attr("opacity", .8);
  ...
  placeCoords: function placeCoords(data) {
    ...
    svg.selectAll("circle").data(tweets).enter().append("circle").attr("cx", function (d) {
      ...
      div.html(d.text).style("left", d3.event.pageX + "px").style("top", d3.event.pageY - 28 + "px").style("color", "white");
